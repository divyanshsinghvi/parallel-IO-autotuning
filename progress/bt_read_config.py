...
logging.debug("BTIO :" + specific_commands)
log = open('../btstats.txt','a')
out=subprocess.Popen(["./run.sh", mpi_hints,dimensions], shell=False, stdout=subprocess.PIPE)
